import { UsersRepository, User } from "./users.repository.js";
...
export const UsersService = {
  ...
  async createItem(
    ...
    const newItem = UsersRepository.create(
      name,
      lastName,
      user_email,
      phone_number,
    ...
    this.evictCacheByPattern("cache:/users*");
  ...
  async updateItem(
    ...
    const updatedItem = UsersRepository.update(
      id,
      name,
      lastName,
      user_email,
    ...
    if (updatedItem) {
      ...
      this.evictCacheByPattern(`cache:/users/${id}`);
      this.evictCacheByPattern("cache:/users*");
    }
